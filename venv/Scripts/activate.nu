...
let virtual-env = "D:\OneDrive\Pós Graduação\1º Semestre\Recuperação da Informação na Web e em Redes Sociais\Exercícios\Projeto Final\venv"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "D:\OneDrive\Pós Graduação\1º Semestre\Recuperação da Informação na Web e em Redes Sociais\Exercícios\Projeto Final\venv\Scripts\deactivate.nu"
